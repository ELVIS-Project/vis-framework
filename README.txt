...
[![Coverage Status](https://img.shields.io/coveralls/ELVIS-Project/vis-framework.svg)](https://coveralls.io/r/ELVIS-Project/vis-framework)
[![Latest Version](https://img.shields.io/pypi/v/vis-framework.svg)](https://pypi.python.org/pypi/vis-framework/)
[![Downloads](https://img.shields.io/pypi/dm/vis-framework.svg)](https://pypi.python.org/pypi/vis-framework/)
[![Travis](https://img.shields.io/travis/ELVIS-Project/vis.svg?branch=master)](https://travis-ci.org/ELVIS-Project/vis-framework)
