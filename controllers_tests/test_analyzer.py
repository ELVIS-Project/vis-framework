...
class TestEventFinderShort(unittest.TestCase):
    ...
    def test_event_finder_short_15(self):
        expected = [(0.0, ('G3', 'G4')), (1.0, ('Rest', 'G4')), (1.5, ('G3', 'G4'))]
        # different if salami=True
        actual = analyzing.AnalysisRecord()
    ...
    def test_event_finder_short_19(self):
        ...
        expected = [(0.5, ('Rest',))]
        actual = analyzing.AnalysisRecord()
        this_piece = event_finder_short.test_19
        self.setts.types = [(note.Rest, lambda x: 'Rest')]
        actual = _event_finder([this_piece[0], this_piece[1]], self.setts, actual)
        self.assertEqual(expected, actual._record)
...
class TestEventFinderJosquin(unittest.TestCase):
    ...
    def test_josquin_1(self):
        ...
        expected_result = [(464 + 0.0, ('A3', 'A3', 'C5', 'Rest')),
                            (464 + 0.5, ('A3', 'A3', 'C5', 'Rest')),
                            (464 + 1.0, ('A3', 'A3', 'C5', 'Rest')),
                            (464 + 1.5, ('A3', 'A3', 'C5', 'Rest')),
...
# Definitions                                                                                      #
#--------------------------------------------------------------------------------------------------#
analyzer_event_finder_short_suite = unittest.TestLoader().loadTestsFromTestCase(
    TestEventFinderShort)
analyzer_event_finder_long_monteverdi = unittest.TestLoader().loadTestsFromTestCase(
    TestEventFinderMonteverdi)
analyzer_event_finder_long_josquin = unittest.TestLoader().loadTestsFromTestCase(
    TestEventFinderJosquin)
