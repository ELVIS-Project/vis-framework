...
def vis_these_parts( these_parts, the_settings, the_statistics ):
   ...
   # How much to increment the offset. With quarterLength==1.0 and offset_interval
   ...
   # most_recent_high == current_offset, which may not be true if, for example
   ...
   while current_offset <= highest_offset:
      ...
      if low_updated or high_updated:
         ...
         if is_note( most_recent_low ) and is_note( most_recent_high ):
            ...
            # TODO: make this work for n != 2
            elif is_rest( previous_lows[-1] ) or is_rest( previous_highs[-1] ):
               # DEBUGGING
            ...
            # statistics!
               ...
               this_ngram = NGram( [interval.Interval( previous_lows[-1], previous_highs[-1] ), this_interval] )
