...
#-------------------------------------------------------------------------------
class Test_Vis_These_Parts_Short_Integration( unittest.TestCase ):
...
#-------------------------------------------------------------------------------
class Test_Vis_These_Parts_Long_Integration( unittest.TestCase ):
   # vis_these_parts( theseParts, theSettings, theStatistics )
   #
...
#------------------------------------------------------------------------------
class Test_Vis_These_Parts_Unit( unittest.TestCase ):
   '''
...
if __name__ == '__main__':
   ...
   vis_these_parts_integration_short_suite = unittest.TestLoader().loadTestsFromTestCase( Test_Vis_These_Parts_Short_Integration )
   vis_these_parts_integration_long_suite = unittest.TestLoader().loadTestsFromTestCase( Test_Vis_These_Parts_Long_Integration )
   ...
   vis_these_parts_unit_suite = unittest.TestLoader().loadTestsFromTestCase( Test_Vis_These_Parts_Unit )
