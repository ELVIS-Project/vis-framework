...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addItem(spacerItem3, 8, 1, 1, 2)
        ...
        self.line_values_of_n = QtGui.QLineEdit(self.grp_settings_for_piece)
        ...
        self.lbl_values_of_n = QtGui.QLabel(self.grp_settings_for_piece)
        self.lbl_values_of_n.setObjectName(_fromUtf8("lbl_values_of_n"))
        self.gridLayout_3.addWidget(self.lbl_values_of_n, 0, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lbl_offset_interval, 1, 0, 1, 1)
        ...
        self.gridLayout_3.addItem(spacerItem4, 9, 1, 1, 1)
        ...
        self.lbl_select_piece = QtGui.QLabel(self.grp_settings_for_piece)
        self.lbl_select_piece.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_select_piece.setObjectName(_fromUtf8("lbl_select_piece"))
        self.gridLayout_3.addWidget(self.lbl_select_piece, 3, 0, 1, 3)
        self.gridLayout_2.addWidget(self.grp_settings_for_piece, 0, 2, 2, 1)
        ...
        self.groupBox_quality = QtGui.QGroupBox(self.groupBox_2)
        self.groupBox_quality.setObjectName(_fromUtf8("groupBox_quality"))
        self.verticalLayout_10 = QtGui.QVBoxLayout(self.groupBox_quality)
        self.verticalLayout_10.setObjectName(_fromUtf8("verticalLayout_10"))
        self.rdo_heedQuality = QtGui.QRadioButton(self.groupBox_quality)
        self.rdo_heedQuality.setObjectName(_fromUtf8("rdo_heedQuality"))
        self.verticalLayout_10.addWidget(self.rdo_heedQuality)
        self.rdo_noHeedQuality = QtGui.QRadioButton(self.groupBox_quality)
        ...
        self.gridLayout.addWidget(self.groupBox_quality, 2, 2, 1, 2)
        ...
        self.rdo_compare.setEnabled( False )
        ...
        self.groupBox_octaves = QtGui.QGroupBox(self.groupBox_2)
        self.groupBox_octaves.setObjectName(_fromUtf8("groupBox_octaves"))
        self.verticalLayout_13 = QtGui.QVBoxLayout(self.groupBox_octaves)
        self.verticalLayout_13.setObjectName(_fromUtf8("verticalLayout_13"))
        self.rdo_compound = QtGui.QRadioButton(self.groupBox_octaves)
        ...
        self.rdo_simple = QtGui.QRadioButton(self.groupBox_octaves)
        self.rdo_simple.setObjectName(_fromUtf8("rdo_simple"))
        self.verticalLayout_13.addWidget(self.rdo_simple)
        self.gridLayout.addWidget(self.groupBox_octaves, 2, 0, 1, 2)
        ...
        self.verticalLayout_18.addWidget(self.line_ngram_in_colour)
        ...
        self.verticalLayout_18.addWidget(self.line_ngram_in_black)
        self.horizontalLayout_6 = QtGui.QHBoxLayout()
        self.horizontalLayout_6.setObjectName(_fromUtf8("horizontalLayout_6"))
        self.btn_targeted_choose_colour = QtGui.QPushButton(self.groupBox_targeted_score)
        self.btn_targeted_choose_colour.setObjectName(_fromUtf8("btn_targeted_choose_colour"))
        self.horizontalLayout_6.addWidget(self.btn_targeted_choose_colour)
        ...
        self.txt_targeted_score = QtGui.QPlainTextEdit(self.groupBox_targeted_score)
        self.txt_targeted_score.setObjectName(_fromUtf8("txt_targeted_score"))
        self.verticalLayout_18.addWidget(self.txt_targeted_score)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.grp_settings_for_piece.setTitle(QtGui.QApplication.translate("MainWindow", "Settings for Piece", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.lbl_values_of_n.setText(QtGui.QApplication.translate("MainWindow", "Values of \'n\':", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.rdo_targeted_score.setText(QtGui.QApplication.translate("MainWindow", "Annotated Score", None, QtGui.QApplication.UnicodeUTF8))
        self.rdo_list.setText(QtGui.QApplication.translate("MainWindow", "List", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_quality.setTitle(QtGui.QApplication.translate("MainWindow", "Interval Quality", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_targeted_score.setTitle(QtGui.QApplication.translate("MainWindow", "Annotated Score", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.btn_targeted_choose_colour.setText(QtGui.QApplication.translate("MainWindow", "Choose Colour", None, QtGui.QApplication.UnicodeUTF8))
