...
# Form implementation generated from reading ui file 'gui_files/compare_voice_pairs.ui'
#
# Created: Mon Oct 15 13:31:36 2012
...
class Ui_Compare_Voice_Pairs(object):
    ...
    def retranslateUi(self, Compare_Voice_Pairs):
        Compare_Voice_Pairs.setWindowTitle(QtGui.QApplication.translate("Compare_Voice_Pairs", "Select Voice Pairs to Compare", None, QtGui.QApplication.UnicodeUTF8))
        self.lbl_instructions.setText(QtGui.QApplication.translate("Compare_Voice_Pairs", "Drag and drop the desired voice pairs from the top box to the two lower boxes.", None, QtGui.QApplication.UnicodeUTF8))
        self.lbl_pairs_in_memory.setText(QtGui.QApplication.translate("Compare_Voice_Pairs", "Voice pairs in memory:", None, QtGui.QApplication.UnicodeUTF8))
        self.lbl_compare_these.setText(QtGui.QApplication.translate("Compare_Voice_Pairs", "Compare these:", None, QtGui.QApplication.UnicodeUTF8))
        self.lbl_to_these.setText(QtGui.QApplication.translate("Compare_Voice_Pairs", "to these:", None, QtGui.QApplication.UnicodeUTF8))
