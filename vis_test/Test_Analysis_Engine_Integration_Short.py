...
class Test_Analysis_Engine_Integration_Short( unittest.TestCase ):
   ...
   def test_theThird( self ):
      ...
      #pprint.pprint( self.stats.get_ngram_dict('compound', 2) )
   ...
   def test_theSixthA( self ):
      ...
      self.assertEqual( len(self.stats.get_compound_interval_summary_dict()), len(expected_compound_intervals) )
      self.assertEqual( self.stats.get_compound_interval_summary_dict(), expected_compound_intervals )
      self.assertRaises(NonsensicalInputWarning, self.stats.get_ngram_dict, self.settings)
...
#for thing in self.stats.get_ngram_dict('compound', 2).iterkeys():
   #if thing in expected_no_quality2grams:
      #if self.stats.get_ngram_dict('compound', 2)[thing] != expected_no_quality2grams[thing]:
         #print( 'for ' + thing + ', actual ' + str(self.stats.get_ngram_dict('compound', 2)[thing]) + ' != expected ' + str(expected_no_quality2grams[thing]) )
   #else:
      #print( 'actual ' + thing + ' isn\'t expected (there are ' + str(self.stats.get_ngram_dict('compound', 2)[thing]) + ')' )

#for thing in expected_no_quality2grams.iterkeys():
   #if thing in self.stats.get_ngram_dict('compound', 2):
      #if self.stats.get_ngram_dict('compound', 2)[thing] != expected_no_quality2grams[thing]:
         #print( 'for ' + thing + ', actual ' + str(self.stats.get_ngram_dict('compound', 2)[thing]) + ' != expected ' + str(expected_no_quality2grams[thing]) )
   #else:
