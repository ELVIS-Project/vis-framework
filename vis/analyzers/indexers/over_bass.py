...
class OverBassIndexer(indexer.Indexer):
    ...
    aggregated_pieces object (see examples below). The DataFrames passed in the 'score' argument 
    ...
    **Example:**
    ...
    input_dfs = [ip.get_data('horizontal_interval'), ip.get_data('vertical_interval')]
    ...
    def __init__(self, score, settings=None):
        ...
        if self._settings['type'] in types and types[self._settings['type']] in self._score:
