...
from vis.analyzers.indexers import interval, dissonance, metre
...
def main():
    ...
    actual = ind_piece.get_data([metre.DurationIndexer]) #dur_indexer.run()['metre.DurationIndexer']
    t1 = time.time()
    print 'Duration Indexer Runtime: ' + str(t1-t0)
    pdb.set_trace()
