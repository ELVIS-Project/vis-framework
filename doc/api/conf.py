# -*- coding: utf-8 -*-
#
# vis documentation build configuration file, created by
...
# so Sphinx tells me about all references where the target cannot be found
nitpicky = False
...
copyright = '&copy; 2013-2017 McGill University, Christopher Antila et al., ' +
  'CC-BY-SA 4.0'
...
version = vis.__version__.split('.')[0]
# The full version, including alpha/beta/rc tags.
release = vis.__version__
...
man_pages = [
    ('index', 'vis', u'VIS Framework Documentation',
     [u'Christopher Antila'], 1)
]
...
texinfo_documents = [
  ('index', 'vis', u'VIS Framework Documentation',
   u'Christopher Antila', 'vis', 'One line description of project.',
   'Miscellaneous'),
]
