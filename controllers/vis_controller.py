...
class VisController(Controller):
    ...
    def __init__(self, arg, interface='PyQt4', details=None):
        ...
        mapper = [
            ...
            (self.displayer.status, self.window.update_progress.emit),
            # error
        ...
        for signal, slot in mapper:
            signal.connect(slot)
        # 5.) Set the models for the table views.
